...
class TaringApi:
	def __init__(self):#variables iniciales
		...
		self.pagina_denuncia = "https://www.taringa.net/denuncia.php"
		self.pagina_bloquear_usuario = "https://www.taringa.net/ajax/user/block"
		...
		self.pagina_comentar_post = "https://www.taringa.net/ajax/comments/add"
